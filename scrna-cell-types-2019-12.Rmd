...
[ClusterMole](https://github.com/igordot/clustermole) is an R package that provides a collection of cell type markers for over 2,000 human and mouse cell populations sourced from a variety of databases.
